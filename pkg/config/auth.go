...
func BasicAuth(cfg *Config) func(w http.ResponseWriter, r *http.Request, next http.HandlerFunc) {
	return func(w http.ResponseWriter, r *http.Request, next http.HandlerFunc) {
		username, password, ok := r.BasicAuth()
		storedUsername, storedPasswordHash := getStoredUsernamePassword(cfg)
...
func getStoredUsernamePassword(cfg *Config) (username, passwordHash string) {
