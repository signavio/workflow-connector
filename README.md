...
The workflow connector executable and example configuration files can be downloaded from the [release page](https://github.com/signavio/workflow-connector/releases) for linux and windows platforms. Alternatively, the executable can be generated by compiling the source code as shown below.
